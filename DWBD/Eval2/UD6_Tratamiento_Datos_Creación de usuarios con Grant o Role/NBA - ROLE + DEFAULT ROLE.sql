...
#------------------------------------------------------------------------------------------------------
	DROP USER IF EXISTS DirectorNBA;	CREATE USER DirectorNBA	IDENTIFIED BY 'dir'		DEFAULT ROLE ROL_DIRECTIVO_NBA;
    DROP USER IF EXISTS JugadorNBA;		CREATE USER JugadorNBA	IDENTIFIED BY 'jug'		DEFAULT ROLE ROL_JUGADOR_NBA;
