...
#------------------------------------------------------------------------------------------------------
#	GRANT	<rol>				TO <usuario>			SET DEFAULT ROLE <rol>	TO <usuario>
#------------------------------------------------------------------------------------------------------
	GRANT	ROL_DIRECTIVO_NBA	TO DirectorNBA; 		SET DEFAULT ROLE ROL_DIRECTIVO_NBA	TO DirectorNBA;
	GRANT	ROL_JUGADOR_NBA		TO JugadorNBA; 			SET DEFAULT ROLE ROL_JUGADOR_NBA	TO JugadorNBA;
