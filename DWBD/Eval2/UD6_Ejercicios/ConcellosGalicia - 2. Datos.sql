...
#------------------------------------------------------------------------------
#	INSERT EN TABLA SIN IDENTIFICADOR
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
#	INSERT EN TABLA SIN ATRIBUTOS
#------------------------------------------------------------------------------
#	INSERT INTO Provincia	VALUES( 10,'A Coruña' );
#	INSERT INTO Provincia	VALUES( 11,'Lugo' );
#	INSERT INTO Provincia	VALUES( 11,'Ourense' );
#	INSERT INTO Provincia	VALUES( 13,'Pontevedra' );    
    
#------------------------------------------------------------------------------
#	INSERT EN TABLA CON ATRIBUTOS
#------------------------------------------------------------------------------
#	INSERT INTO Provincia( idProvincia, Nombre )	VALUES( 10,'A Coruña' );
#	INSERT INTO Provincia( Nombre, idProvincia )	VALUES( 'Lugo',  11 );
#	INSERT INTO Provincia( idProvincia, Nombre )	VALUES( 12,'Ourense' );
#	INSERT INTO Provincia( Nombre, IdProvincia )	VALUES( 'Pontevedra', 13 );    
    
#------------------------------------------------------------------------------
#	INSERT EN TABLA SIN ATRIBUTOS Y TUPLAS SEPARADAS POR COMAS
#------------------------------------------------------------------------------
#	INSERT INTO Provincia	
#		VALUES( 10,'A Coruña' ), ( 11,'Lugo' ), ( 12,'Ourense' ), ( 13, 'Pontevedra' );    
#------------------------------------------------------------------------------
#	INSERT EN TABLA CON ATRIBUTOS Y TUPLAS SEPARADAS POR COMAS
#------------------------------------------------------------------------------
#	INSERT INTO Provincia( idProvincia, Nombre )
#		VALUES( 10,'A Coruña' ), ( 11,'Lugo' ), ( 12,'Ourense' ), ( 13, 'Pontevedra' );    
    
#------------------------------------------------------------------------------
#	INSERT EN TABLA CON COMANDO SET
#------------------------------------------------------------------------------
#    INSERT INTO Provincia SET idProvincia = 10, Nombre = 'A Coruña';
#    INSERT INTO Provincia SET idProvincia = 11, Nombre = 'Lugo';
#    INSERT INTO Provincia SET idProvincia = 12, Nombre = 'Ourense';
#    INSERT INTO Provincia SET idProvincia = 13, Nombre = 'Pontevedra';

#------------------------------------------------------------------------------
#	INSERT EN TABLA CON COMANDO SET SIN IDENTIFICADOR
#------------------------------------------------------------------------------
    INSERT INTO Provincia SET Nombre = 'A Coruña';
    INSERT INTO Provincia SET Nombre = 'Lugo';
    INSERT INTO Provincia SET Nombre = 'Ourense';
    INSERT INTO Provincia SET Nombre = 'Pontevedra';
