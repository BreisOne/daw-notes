...
CREATE PROCEDURE contratarTrabajador( empleadoDNI VARCHAR(40), contrato VARCHAR(40), Fecha DATE, OficinaTrabajo INT, Puesto VARCHAR(50), Jefe INT)
	BEGIN
    DECLARE empleadoID INT;
    SET empleadoID = (SELECT idEmpleado from empleado WHERE NIFEmpleado = empleadoDNI);
    call agregarContratacion(contrato, Fecha, NULL, empleadoID, OficinaTrabajo, Puesto, Jefe);
    END //
DELIMITER ;
...
CREATE PROCEDURE mostrarContratosTrabajador( empleadoDNI VARCHAR(9))
	BEGIN
    SELECT idContratacion, tipoContrato, inicioContratacion, finContratacion, Empleado, Oficina, puestoTrabajo, Jefe
    FROM contratacion INNER JOIN empleado ON contratacion.empleado = empleado.idEmpleado WHERE NIFEmpleado = empleadoDNI;
    END //
DELIMITER ;
...
#	- Despide al trabajador/es que desees con fecha de '2024-03-02'
		call despedirTrabajador("64444444D", '2024-03-02');
#	- Contrata a ese mismo trabajador/es para realizar un 'Proyecto' como contrato, con fecha de '2024-03-02', asigna una oficina de trabajo, un puesto y un jefe
		call contratarTrabajador("64444444D", 'Proyecto', '2024-03-02', 4, 'Trabajador de Ventas',4);
#	- Despide a ese trabajador/es con fecha de '2024-03-12'
		call despedirTrabajador("64444444D", '2024-03-12');
#	- Contrata a ese mismo trabajador/es para realizar otro 'Proyecto' como contrato, con fecha de '2024-03-14', asigna una oficina de trabajo, un puesto y un jefe
		call contratarTrabajador("64444444D", 'Proyecto', '2024-03-14', 6, 'Trabajador de Atención al Cliente',5);
#	- Despide a ese trabajador/es con fecha de '2024-03-17'
		call despedirTrabajador("64444444D", '2024-03-17');
#	- Contrata a ese mismo trabajador/es con contrato indefinido, con fecha de '2024-03-20', asigna una oficina de trabajo, un puesto y un jefe
		call contratarTrabajador("64444444D", 'Indefinido', '2024-03-20', 5, 'Jefe de Ventas',1);
#	- Despide a ese trabajador/es con fecha de '2024-03-27'
		call despedirTrabajador("64444444D", '2024-03-27');
#	- Contrata a ese mismo trabajador/es con contrato indefinido, con fecha de '2024-03-30', asigna una oficina de trabajo, un puesto y un jefe
		call contratarTrabajador("64444444D", 'Indefinido', '2024-03-30', 5, 'Jefe de Ventas',1);
#	- Despide a ese trabajador/es con fecha de '2024-04-12'
		call despedirTrabajador("64444444D", '2024-04-12');
#	- Muestra los Contratos de ese trabajador/es
		call mostrarContratosTrabajador("64444444D");
#---------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------
