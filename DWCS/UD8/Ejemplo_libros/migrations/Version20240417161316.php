 ...
 */
final class Version20240417161316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nota ADD fecha_modificion DATETIME NOT NULL, CHANGE description descripcion VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nota DROP fecha_modificion, CHANGE descripcion description VARCHAR(255) NOT NULL');
    }
}
